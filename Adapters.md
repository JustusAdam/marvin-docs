...
Users can define their own adapters of course but are strongly encouraged to release generic adapters publicly or [contribute them to marvin](https://github.com/JustusAdam/marvin/pulls).
